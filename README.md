...
- [`assignments_check`](https://github.com/secureflag/actions/blob/main/.github/actions/assignments_check/README.md): Verify that contributors have completed their required SecureFlag assignments (initial, pending, or non-expired) before allowing code to be merged.
...
- [`repo_to_threat_model`](https://github.com/secureflag/actions/blob/main/.github/actions/repo_to_threat_model/README.md): Analyze your codebase and generate threat models using SecureFlag's ThreatCanvas.